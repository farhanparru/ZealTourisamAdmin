...
const EditVisModal = () => {
  ...
  useEffect(() => {
    const fetchHoliday = async () => {
      try {
        const response = await axios.get(`https://api.zealtourism.com/api/global-visa/${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        ...
        const response = await axios.put(`https://api.zealtourism.com/api/global-visa/${id}`, formData, {
            headers: {
