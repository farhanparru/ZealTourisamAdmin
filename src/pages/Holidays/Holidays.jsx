...
const Holidays = () => {
  ...
  useEffect(() => {
    const fetchHolidays = async () => {
      try {
        const response = await axios.get("https://zeal-tourisam-backend.vercel.app/api/holidays", {
          headers: {
  ...
  const handleDelete = async (id) => {
    console.log(id, "id::::::::");
    try {
      await axios.delete(`https://zeal-tourisam-backend.vercel.app/api/holidays/${id}`, {
        headers: {
          "x-access-token": localStorage.getItem("adminToken"),
        },
      }); // Replace with your API URL
