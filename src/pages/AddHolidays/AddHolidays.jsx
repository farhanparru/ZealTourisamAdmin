...
const Holidays = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    formDataToSend.append(
      "tourOverview",
      JSON.stringify(holidayData.tourOverview)
    );
    ...
    formDataToSend.append(
      "bookingPolicy",
      JSON.stringify(holidayData.bookingPolicy)
    );
    ...
    try {
      const response = await axios.post('https://zeal-tourisam-api.vercel.app/api/holidays', formDataToSend, {
        headers: {
  ...
  const removeItinerary = (index) => {
    const updatedItinerary = holidayData.itinerary.filter(
      (_, i) => i !== index
    );
    setHolidayData({ ...holidayData, itinerary: updatedItinerary });
  };
      ...
      <div className="holiday-form">
        ...
        <div className="holidaySecondFrom">
          <div className="holidaysecondfrom1">
            ...
            <button
              className="btn-add"
              onClick={() => setBookingPolicyModalOpen(true)}
            >
              Add Booking Policy
            </button>

            <button className="btn-add" onClick={() => setFaqModalOpen(true)}>
              Add FAQs
            </button>
            <button type="button" className="btn-add" onClick={openDetailModal}>
              Add More Details
            </button>
            {/* <button
              type="button"
            ...
            type="btn-add"
            onClick={openModal}
            className="btn add-itinerary-btn"
          >
            Add Itinerary
          </button>
          </div>
        ...
        <BookingPolicyModal
          ...
          onClose={() => setBookingPolicyModalOpen(false)}
