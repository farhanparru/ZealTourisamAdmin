...
const UpdateHolidays = () => {
    ...
    useEffect(() => {
        const fetchHoliday = async () => {
            try {
                const response = await axios.get(`https://zeal-tourisam-api.vercel.app/api/holidays/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.put(`https://zeal-tourisam-api.vercel.app/api/holidays/${id}`, formDataToSend, {
                headers: {
    ...
    return (
        <div className="holidays-containers">
            ...
            <div className="holiday-form">
                ...
                <textarea name="description" placeholder="Description" value={holidayData.description || ''} onChange={handleChange} className="holiday-input"></textarea>

                <input type="text" name="slug" placeholder="Slug" value={holidayData.slug || ''} onChange={handleChange} required className="holiday-input" />
